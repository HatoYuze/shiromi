...
package com.github.hatoyuze.shiromi.gui.data.repository

import com.github.hatoyuze.shiromi.gui.ChatMessage
import com.github.hatoyuze.shiromi.gui.ChatSession
import com.github.hatoyuze.shiromi.gui.CalendarEventEntity
import com.github.hatoyuze.shiromi.gui.ChatBranch
import com.github.hatoyuze.shiromi.gui.StudyTopicEntity
import com.github.hatoyuze.shiromi.gui.LuoguDatabase
import com.github.hatoyuze.shiromi.gui.TodoItem
import com.github.hatoyuze.shiromi.gui.data.local.DatabaseWrapper
import com.github.hatoyuze.shiromi.gui.data.local.ZstdCompression
import com.github.hatoyuze.shiromi.gui.domain.interfaces.ChatRepository
import com.github.hatoyuze.shiromi.gui.domain.model.*
import app.cash.sqldelight.coroutines.asFlow
import app.cash.sqldelight.coroutines.mapToList
import com.github.hatoyuze.shiromi.gui.DailyProblemContext
import com.github.hatoyuze.shiromi.gui.DailyProblemCache
    ...
    override suspend fun insertRecommendation(sessionId: String, pid: String) {
        withContext(Dispatchers.Default) {
            queries.insertRecommendation(
                sessionId = sessionId,
                pid = pid,
                createdAt = com.github.hatoyuze.shiromi.gui.platform.currentTimeMillis(),
            )
        }
    }
...
private fun serializeToolCalls(toolCalls: List<com.github.hatoyuze.shiromi.gui.domain.model.ToolCallInfo>?): ByteArray? {
...
private fun deserializeToolCalls(raw: ByteArray?): List<com.github.hatoyuze.shiromi.gui.domain.model.ToolCallInfo>? {
...
private fun serializeSegments(segments: List<com.github.hatoyuze.shiromi.gui.domain.model.MessageSegment>?): ByteArray? {
...
private fun deserializeSegments(raw: ByteArray?): List<com.github.hatoyuze.shiromi.gui.domain.model.MessageSegment>? {
    if (raw == null) return null
    return try {
        val json = ZstdCompression.decompress(raw)
        toolCallsJson.decodeFromString(kotlinx.serialization.serializer(), json)
