...
import com.github.hatoyuze.shiromi.gui.domain.chat.parseAskUserArgs
...
import com.github.hatoyuze.shiromi.gui.presentation.utils.ChatJobManager
...
class ChatViewModel(
    ...
    /** Drives the askuser card from service-emitted [com.github.hatoyuze.shiromi.gui.domain.chat.UserQuestion]s. */
    ...
    private suspend fun streamAssistantResponse(
        ...
        jobState: com.github.hatoyuze.shiromi.gui.presentation.utils.ChatJobManager.JobState,
