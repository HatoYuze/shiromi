...
class ChatJobManager(private val maxConcurrent: Int = 5) {
    ...
    val pendingToolCalls: MutableMap<String, com.github.hatoyuze.shiromi.gui.domain.chat.ChatService.StreamEvent.ToolCall> = mutableMapOf(),
        val completedToolCalls: MutableList<com.github.hatoyuze.shiromi.gui.domain.model.ToolCallInfo> = mutableListOf(),
        /** Track AskUser segments created by ToolCall for later update on ToolResult. */
        val pendingAskUserSegments: MutableMap<String, com.github.hatoyuze.shiromi.gui.domain.model.MessageSegment.AskUser> = mutableMapOf(),
        /**
         ...
         */
        val segments: MutableList<com.github.hatoyuze.shiromi.gui.domain.model.MessageSegment> = mutableListOf(),
    )
