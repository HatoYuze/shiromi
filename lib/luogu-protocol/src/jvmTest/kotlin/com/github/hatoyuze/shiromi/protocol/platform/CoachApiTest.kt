...
import com.github.hatoyuze.shiromi.protocol.coach.CoachFinishedResponse
import com.github.hatoyuze.shiromi.protocol.coach.CoachInitResponse
import com.github.hatoyuze.shiromi.protocol.coach.CoachProcessingResponse
import com.github.hatoyuze.shiromi.protocol.coach.CoachResponse
import com.github.hatoyuze.shiromi.protocol.coach.LevelHistoryEntry
import com.github.hatoyuze.shiromi.protocol.coach.MemoryProvider
import com.github.hatoyuze.shiromi.protocol.coach.SelectedResult
import com.github.hatoyuze.shiromi.protocol.coach.StudentMemory
import com.github.hatoyuze.shiromi.protocol.coach.installAllTools
import com.github.hatoyuze.shiromi.protocol.coach.installCoachTools
import com.github.hatoyuze.shiromi.protocol.coach.parseCoachResponse
...
class CoachApiTest {
    ...
    @Test fun `installCoachTools registers 2 tools`() {
        val h = toolHost { installCoachTools(emptyProvider()) }
    ...
    @Test fun `installAllTools registers 11 tools`() {
        val h = toolHost { installAllTools(LuoguApi(), emptyProvider()) }
    ...
    @Test fun `get_memory returns default when null`() = runTest {
        val p = emptyProvider()
        val host = toolHost { installCoachTools(p) }
