...
import com.github.hatoyuze.luogu.skill.platform.loadTagResourceJson
...
enum class DifficultyLevel(val id: Int, val label: String, val color: String) {
    ...
    POPULARIZATION(3, "普及/提高−", "#ffc116"),
    POPULARIZATION_PLUS(4, "普及+/提高", "#52c41a"),
    IMPROVEMENT(5, "提高+/省选−", "#3498db"),
    PROVINCIAL(6, "省选/NOI−", "#9d3dcf"),
    NOI_MINUS(7, "NOI/NOI+/CTSC", "#0e1d69"),
    NOI(8, "NOI/CTSC", "#0e1d69");
...
object LuoguTags {
    ...
    private val resourceJson = kotlinx.serialization.json.Json { ignoreUnknownKeys = true }
