...
import com.github.hatoyuze.shiromi.protocol.platform.createPlatformHttpClient
import com.github.hatoyuze.shiromi.protocol.platform.decompressGzip
import com.github.hatoyuze.shiromi.protocol.platform.percentDecode
...
internal class LuoguHttpClient {
    ...
    /** 读取响应体，若为 gzip 则自动解压 */
    internal suspend fun HttpResponse.readDecompressed(): String {
